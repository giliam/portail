...
urlpatterns += patterns('association.views',
    ...
    url(r'^(?P<association_pseudo>\w+)/anciennes_equipes/$', 'anciennes_equipes'),
    ...
    url(r'^(?P<association_pseudo>\w+)/equipe/mettre_a_la_retraite/(?P<adhesion_id>\d+)$', 'mettre_a_la_retraite'),    
    url(r'^(?P<association_pseudo>\w+)/equipe/remettre_actif/(?P<adhesion_id>\d+)$', 'remettre_actif'),    
    url(r'^(?P<association_pseudo>\w+)/equipe/ajouter_membre/$', 'ajouter_membre'),
    url(r'^(?P<association_pseudo>\w+)/equipe/supprimer_membre/$', 'supprimer_membre', {'adhesion_id':None}),
    url(r'^(?P<association_pseudo>\w+)/equipe/supprimer_membre/(?P<adhesion_id>\d+)$', 'supprimer_membre'),
